...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    '''
    Бизнес: Парсит XML фид от Admitad и сохраняет товары в БД
    Args: event - dict с httpMethod
          context - объект с request_id
    Returns: HTTP ответ с количеством обработанных товаров
    '''
    ...
    try:
        ...
        return {
            ...
            'body': json.dumps({
                ...
                'message': f'Успешно обработано {len(products)} товаров'
            })
        }
